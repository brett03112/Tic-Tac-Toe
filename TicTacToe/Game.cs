...
public class TicTacToe
{
    ...
    /// <summary>
    /// Gets the player's move and updates the board accordingly.
    /// </summary>
    /// <remarks>
    /// This method will keep asking for input until a valid move is made.
    /// </remarks>
    ...
    /// <summary>
    /// Gets the computer's move and updates the board accordingly.
    /// </summary>
    /// <remarks>
    /// The difficulty level of the AI determines the computer's move.
    /// </remarks>
    ...
    /// <summary>
    /// Gets the computer's move based on the difficulty level.
    /// </summary>
    ...
    /// <summary>
    /// Let's the computer make a easy move.
    /// </summary>
    /// <returns>Returns the computer's move between 1-9</returns>
    ...
    /// <summary>
    /// Makes a medium level move. The computer will first try to win, then block the player from winning.
    /// If no winning or blocking move is available, the computer will make a random move.
    /// </summary>
    /// <returns>The computer's move.</returns>
    ...
    /// <summary>
    /// Makes a hard level move. The computer will use a minimax algorithm to find the best move.
    /// </summary>
    /// <returns>The computer's move.</returns>
    ...
    /// <param name="depth">The current depth of the search tree.</param>
    /// <param name="isMaximizing">A boolean value indicating whether the current player is maximizing or minimizing.</param>
    ...
    /// <summary>
    /// Checks if a move is valid based on the choice made by the player.
    /// </summary>
    /// <param name="choice">The choice made by the player (1-9).</param>
    /// <returns>A boolean value indicating whether the move is valid.</returns>
